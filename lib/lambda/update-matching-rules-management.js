...
const centralEventBridgeRuleName = process.env.CENTRAL_EVENT_BRIDGE_RULE_NAME;
...
// EventBridge Rule
const rule = {
  name: centralEventBridgeRuleName,
  sources: ['aws.cloudwatch', 'aws.ec2', 'aws.rds'],
  description: 'The Rule propagates all Amazon CloudWatch Events, AWS EC2 Events, AWS RDS Events to the eventbus'
}
